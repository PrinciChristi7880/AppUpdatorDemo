...
import com.eggheadgames.siren.R;
...
class SirenHelper {
    ...
    void openAppSite(Activity activity){
        if (activity == null) {
            return;
        }

        try {
            activity.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.mysportsleague.co/apk/mysportsleague.apk")));
